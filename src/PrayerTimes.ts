...
export default class PrayerTimes {
  ...
  constructor(
    ...
    //===cal for dahwa===
    const durationBetweenFajrAndMaghrib =
      maghribTime.getTime() - fajrTime.getTime();
    ...
    this.dahwa = roundedMinute(dahwaTime, calculationParameters.rounding); // for dahwa
  }
